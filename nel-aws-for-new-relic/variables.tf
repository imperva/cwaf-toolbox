...
variable "reg_email" {default = "joe.moore@imperva.com"}
variable "subject_organization" {default = "Imperva"}
variable "subject_organizational_unit" {default = "OCTO"}
variable "subject_country" {default = "US"}
variable "subject_postal_code" {default = "94403"}
variable "locality" {default = "San Mateo"}
variable "serial_number" {default = "1"}
variable "naked_domain" {default = "dev.impervademo.com"}
